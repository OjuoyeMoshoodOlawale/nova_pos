...
// Helper: strongly-typed invoke wrapper
...
const api = {
  ...
  settings: {
    ...
    testPrint:     ()                     => invoke(CH.SETTINGS_TEST_PRINT),
  ...
  sales: {
    ...
    hold:         (cart: string, label: string | null, custId: number | null, uid: number) => invoke(CH.SALE_HOLD, cart, label, custId, uid),
