-- ══════════════════════════════════════════════════════
-- Migration 001: Initial NovaPOS Schema
-- ══════════════════════════════════════════════════════
...
-- ─── ACTIVATION ──────────────────────────────────────
-- Stores the activation key record (one row only)
...
CREATE TABLE IF NOT EXISTS sale_items (
  ...
  cost_price   REAL    NOT NULL    DEFAULT 0  -- snapshot for COGS calc
);

CREATE INDEX IF NOT EXISTS idx_sale_items_sale    ON sale_items(sale_id);
CREATE INDEX IF NOT EXISTS idx_sale_items_product ON sale_items(product_id);

-- ─── PAYMENTS (SUPPORTS SPLIT) ───────────────────────
...
-- ─── STOCK ADJUSTMENTS ───────────────────────────────
-- Covers: opening_balance, restock, damage, theft, correction, sale, return
